...
import { HomeWork, HomeWorkType } from "@/app/libs/models/homework";
        ...
        <div className="p-4 flex flex-col gap-4 justify-start bg-white rounded-2xl border border-border hover:shadow-lg hover:shadow-gray-500/15 cursor-pointer transition duration-300 hover:border-input-text/10">
            <section className="flex gap-2 items-center justify-between flex-wrap">
                ...
                <div className="flex items-center gap-1">
                    <button className="p-1 rounded-[7px] text-[#65758b] cursor-pointer hover:text-[#cc1d1d] hover:bg-[#cc1d1d]/20 transition duration-300">
                ...
                {/* <button command="show-modal" commandfor="dialog" className="rounded-md bg-input-text/10 px-2.5 py-1.5 text-sm font-semibold text-black inset-ring inset-ring-white/5 hover:bg-white/20">Open dialog</button>
                <el-dialog>
                                ...
                                <div className="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            <h3 id="dialog-title" className="text-base font-semibold text-white">Deactivate account</h3>
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-400">Are you sure you want to deactivate your account? All of your data will be permanently removed. This action cannot be undone.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
